...
public class Registration_FormsBUS {
    ...
    public boolean insert(Registration_FormsDTO registration_form) {
        try {
            Registration_FormsDTO result = registration_formDAO.insert(registration_form);
    ...
    public boolean update(Registration_FormsDTO registration_form) {
        ...
        if (index != -1) {
            try {
                boolean res = registration_formDAO.update(registration_form);
                if (res) {
    ...
    public boolean delete(int id) {
        ...
        if (index != -1) {
            try {
                boolean res = registration_formDAO.delete(id);
                if (res) {
