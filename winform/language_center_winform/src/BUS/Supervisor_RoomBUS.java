...
public class Supervisor_RoomBUS {
    ...
    public boolean insert(Supervisor_RoomDTO supervisor_room) {
        try {
            Supervisor_RoomDTO result = supervisor_roomDAO.insert(supervisor_room);
    ...
    public boolean update(Supervisor_RoomDTO supervisor_room) {
        ...
        if (index != -1) {
            try {
                boolean res = supervisor_roomDAO.update(supervisor_room);
                if (res) {
    ...
    public boolean delete(int id) {
        ...
        if (index != -1) {
            try {
                boolean res = supervisor_roomDAO.delete(id);
                if (res) {
